...
- **The same stale claim appears two sections up, inside the 2026-09-14 revision's addendum, and is
  corrected here rather than there because that heading reads `## Revision`, not `## Amendment` -
