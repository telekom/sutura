...
///
/// Limit: the extraction is per LINE, as [`stale_phrases`]' is, so an inline-code span wrapped
/// across two lines is missed. That under-reports; it cannot redden a correct tree.
