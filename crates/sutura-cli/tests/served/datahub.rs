...
//!
//! `open_one_datahub_catalog` (`crates/sutura-cli/src/catalog.rs`) fixes the `dataPlatform` -> source
...
//! # RED/GREEN
//!
//! The mutation this cell is meant to catch: revert `crates/sutura-cli/src/catalog.rs`'s `Datahub` arm to
...
mod tests {
    ...
    ///
    /// **RED/GREEN.** Removing the `outbound` threading from `crates/sutura-cli/src/catalog.rs` (or
