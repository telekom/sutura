...
| `metrics_span_different_models` | `422`  | The named metrics do not share a model, time column, grain and dimensions. Ask about each separately - this deployment executes one metric at a time regardless                                                                                                                                                                                                                                                                                                                                                                                               |
| `multi_metric_not_executable`   | `422`  | Every named metric resolved and agrees, but this deployment does not yet turn more than one into one answer. Ask about each separately                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
first half does not survive checking: nothing mainstream retries a `4xx` by default, and 9 refusal
