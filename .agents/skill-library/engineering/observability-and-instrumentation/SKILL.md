...
- Upstream: `github.com/addyosmani/agent-skills`, `skills/observability-and-instrumentation/SKILL.md`
- Licence: MIT. Commit `5a5ea45e806f82273549fd85e60adb95d55f510d`, 2026-08-21
- Local status: **mirror** - imported as-is. Where it conflicts with `AGENTS.md` or an
  active skill, those win; say so rather than silently choosing.
