...
//! crossed the 1000-line cap for the second time - `bigquery.rs` is its sibling and took the same
//! shape. The parent keeps what belongs to neither kind: the shared shapes, the settings door, the
//! `kind:` dispatch and the two-load table check.
//!
