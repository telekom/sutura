...
audit sink, so a refusal is a value the caller receives and is recorded nowhere. The MCP and HTTP
surfaces, Arrow results with provenance, and federation are ahead of it too.
