...
### One ordering in the OPEN work is a security constraint, not a preference

The six above are about the twenty-six numbered steps. This one is about work raised since, and
it is here rather than on the issues for one reason: **GitHub's *blocked by* records THAT one
thing waits for another and cannot record why, and here the why is the whole constraint.**
