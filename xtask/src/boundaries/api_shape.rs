...
mod tests {
    ...
    fn a_binary_may_use_a_dynamic_error_crate() {
        ...
        assert!(dynamic_error_deps(&metadata()).expect("fixture walks").is_empty());
    }
    ...
    fn a_method_after_the_body_is_not_a_field() {
        ...
        assert!(pub_field_violations("x.rs", text).is_empty());
    }
    ...
    fn a_single_parameter_alias_is_not_read_as_an_error_type() {
        ...
        assert!(result_error_types("fn f() -> Result<String>").is_empty());
    }
