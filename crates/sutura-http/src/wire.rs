...
/// What the catalog route serves, kept apart from the question and the answer for the reason
/// `cargo xtask max-lines` gives: this file crossed the thousand-line gate under `crates/`, which
/// cannot be exempted.
mod catalog;
...
mod tests {
    ...
    use super::{MalformedQuestion, Outcome, QuestionBody};
