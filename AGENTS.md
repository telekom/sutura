...
- **Least authority on the execution leg.** End-to-end impersonation is the point of the product: a
  ...
  signature that runs as this process, which is what the fallback used to be. What is NOT built is a
